...
export const ChevronIcon = ({iconOptions, description}) => {
  ...
  return (
    <div onMouseOver={() => {setIsHovered(true)}} onMouseOut={() => {setIsHovered(false)}}>
      {isHovered && description ? <IconBubble description={description} /> : null}
...
export const StopIcon = ({iconOptions, description}) => {
  ...
  return (
    <div onMouseOver={() => {setIsHovered(true)}} onMouseOut={() => {setIsHovered(false)}}>
      {isHovered && description ? <IconBubble description={description} /> : null}  
      <svg {...iconOptions} fill="none" stroke="currentColor" strokeWidth={2.2} viewBox="0 0 24 24" aria-hidden="true">
