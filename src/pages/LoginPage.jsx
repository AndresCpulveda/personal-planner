          ...
          <div className="relative p-5">
            <div className="text-center">
              ...
              <div>
                ...
                <div className="mt-2 text-sm">
                  <p>
                    Organize your tasks and optimize your time with this simple
                    tool.
                  </p>
            ...
            <div className="mt-5 flex justify-end gap-3">
              <button
                ...
                type="button"
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-blue-500 bg-white px-5 py-2.5 text-center text-sm font-medium text-blue-500 shadow-sm transition-all hover:bg-blue-700 hover:text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
